					...
					<Route path="/" element={<MainLayout />}>
						<Route element={<ProtectedRoute allowed={["admin"]} />}>
							<Route
								...
								element={<Page_Company_Account />}
							/>
							<Route
								path="/company/account/blacklist"
								element={<Page_Company_Account_Blacklist />}
							/>
							<Route
								path="/company/account/create"
								element={<Page_Company_Account_Create />}
							/>
						</Route>
						...
						>
							<Route
								path="/company/event"
								element={<Page_Company_Event />}
							/>
							<Route
								path="/company/event/:eventid"
								element={<Page_Company_Event_Id />}
							/>
						</Route>

						<Route
							element={<ProtectedRoute allowed={["recruiter"]} />}
						>
							<Route
								path="/company/event/create"
								element={<Page_Company_Event_Create />}
							/>
							<Route
								path="/company/event/:eventid/update"
								element={<Page_Company_Event_Id_Update />}
							/>
						</Route>
						...
						>
							<Route
								...
								element={<Page_Company_Interview />}
							/>
						</Route>
						...
						>
							<Route
								path="/company/interview/create"
								element={<Page_Company_Interview_Create />}
							/>
						</Route>
						...
						>
							<Route
								path="/company/interview/:interviewid"
								element={<Page_Company_Interview_Id />}
							/>
						</Route>
						...
						<Route
							element={
								<ProtectedRoute
									allowed={["interviewer", "admin"]}
								/>
							}
						>
							<Route
								path="/company/question"
								element={<Page_Company_Question />}
							/>
						</Route>
						...
						>
							<Route
								path="/company/interview/:interviewid/update"
								element={<Page_Company_Interview_Id_Update />}
							/>

							<Route
								path="/company/recruitment"
								element={<Page_Company_Recruitment />}
							/>

							<Route
								path="/company/recruitment/create"
								element={<Page_Company_Recruitment_Create />}
							/>

							<Route
								path="/company/recruitment/:recruitmentid"
								element={<Page_Company_Recruitment_Id />}
							/>

							<Route
								path="/company/recruitment/:recruitmentid/application/:applicationid"
								element={
									<Page_Company_Recruitment_Id_Application_Id />
								}
							/>

							<Route
								path="/company/recruitment/:recruitmentid/update"
								element={<Page_Company_Recruitment_Id_Update />}
							/>

							<Route
								path="/company/recruitment/:recruitmentid/report"
								element={<Page_Company_Recruitment_Id_Report />}
							/>
						</Route>
						...
						>
							<Route
								path="/company/interview/:interviewid/start"
								element={<Page_Company_Interview_Id_Start />}
							/>
						</Route>
						...
						<Route
							path="/event/:eventid"
							element={<Page_Event_Id />}
						/>
						<Route path="/home" element={<Page_Home />} />

						<Route
							element={<ProtectedRoute allowed={["candidate"]} />}
						>
							<Route
								path="/interview/:interviewid"
								element={<Page_Interview_Id />}
							/>
						</Route>
						...
						>
							<Route
								...
								element={<Page_Profile_CvCreate />}
							/>
							<Route
								path="/profile/:profileid/cv"
								element={<Page_Profile_Id_Cv />}
							/>
							<Route
								path="/profile/:profileid/cv/:cvid"
								element={<Page_Profile_Id_Cv_Id />}
							/>
							<Route
								path="/profile/:profileid/cv/:cvid/update"
								element={<Page_Profile_Id_Cv_Id_Update />}
							/>

							<Route
								path="/profile/:profileid/interview"
								element={<Page_Profile_Id_Interview />}
							/>
							<Route
								path="/profile/:profileid/event"
								element={<Page_Profile_Id_Event />}
							/>
							<Route
								path="/profile/:profileid/application"
								element={<Page_Profile_Id_Application />}
							/>
						</Route>
						...
						>
							<Route
								...
								element={<Page_Profile_Id />}
							/>
							<Route
								path="/profile/:profileid/changepassword"
								element={<Page_Profile_Id_ChangePassword />}
							/>
						</Route>

						<Route
							path="/recruitment"
							element={<Page_Recruitment />}
						/>
						<Route
							path="/recruitment/:recruitmentid"
							element={<Page_Recruitment_Id />}
						/>
						...
						>
							<Route
								path="/recruitment/:recruitmentid/application/:applicationid"
								element={<Page_Recruitment_Id_Application_Id />}
							/>
						</Route>
